...
Next.js 15 기반으로 구축된 웹사이트로, 다양한 재미있는 도구와 정적 블로그를 제공합니다.

블로그 포스트는 MDX 파일을 기반으로 빌드 시 정적으로 생성되어 빠른 로딩 속도와 SEO 최적화를 지원합니다. 또한 한국어와 영어를 포함한 다국어를 지원하며, 다크 모드와 반응형 디자인을 통해 다양한 기기에서 편리하게 이용할 수 있습니다.
